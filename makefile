...
install-cron:
	...
	@(crontab -l 2>/dev/null; \
	  ...
	  echo "0 9 * * 1-5 cd /home/niwa_kazuhiro/stockManegement && source venv/bin/activate && /home/niwa_kazuhiro/stockManegement/venv/bin/python main.py daily > /home/niwa_kazuhiro/stockManegement/cron_daily_morning.log  2>&1"; \
	  echo "# Daily Evening Report (4:00 PM weekdays)"; \
	  echo "0 16 * * 1-5 cd /home/niwa_kazuhiro/stockManegement && source venv/bin/activate && /home/niwa_kazuhiro/stockManegement/venv/bin/python main.py daily  && gcloud storage cp /home/niwa_kazuhiro/stockManegement/data gs://stock-managemet-report-file/ --recursive && gcloud storage objects update gs://stock-managemet-report-file/**/*.txt --content-type='text/plain; charset=utf-8'&& gcloud storage objects update gs://stock-managemet-report-file/**/*.csv --content-type='text/csv; charset=utf-8'&& gcloud storage objects update gs://stock-managemet-report-file/**/*.png --content-type="image/png" && /home/niwa_kazuhiro/stockManegement/scripts/send_report.sh daily> /home/niwa_kazuhiro/stockManegement/cron_daily_evening.log 2>&1"; \
	  echo "# Weekly tasks (Saturday 10:00 AM)"; \
	  echo "0 10 * * 6 cd /home/niwa_kazuhiro/stockManegement && source venv/bin/activate && /home/niwa_kazuhiro/stockManegement/venv/bin/python main.py weekly  && gcloud storage cp /home/niwa_kazuhiro/stockManegement/data gs://stock-managemet-report-file/ --recursive && gcloud storage objects update gs://stock-managemet-report-file/**/*.txt --content-type='text/plain; charset=utf-8'&& gcloud storage objects update gs://stock-managemet-report-file/**/*.csv --content-type='text/csv; charset=utf-8' && gcloud storage objects update gs://stock-managemet-report-file/**/*.png --content-type="image/png" && /home/niwa_kazuhiro/stockManegement/scripts/send_report.sh weekly> /home/niwa_kazuhiro/stockManegement/cron_weekly.log 2>&1"; \
	  echo "# Monthly tasks (1st day 10:00 AM)"; \
	  echo "0 10 1 * * cd /home/niwa_kazuhiro/stockManegement && source venv/bin/activate && /home/niwa_kazuhiro/stockManegement/venv/bin/python main.py monthly  && gcloud storage cp /home/niwa_kazuhiro/stockManegement/data gs://stock-managemet-report-file/ --recursive && gcloud storage objects update gs://stock-managemet-report-file/**/*.txt --content-type='text/plain; charset=utf-8'&& gcloud storage objects update gs://stock-managemet-report-file/**/*.csv --content-type='text/csv; charset=utf-8' && gcloud storage objects update gs://stock-managemet-report-file/**/*.png --content-type="image/png" && /home/niwa_kazuhiro/stockManegement/scripts/send_report.sh monthly> /home/niwa_kazuhiro/stockManegement/cron_monthly.log 2>&1"; \
	  echo "# Yearly tasks (Jan 1, 12:00 PM)"; \
	  echo "0 12 1 1 * cd /home/niwa_kazuhiro/stockManegement && source venv/bin/activate && /home/niwa_kazuhiro/stockManegement/venv/bin/python main.py yearly > /home/niwa_kazuhiro/stockManegement/cron_yearly.log 2>&1" \
	) | crontab -
