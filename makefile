...
install-cron:
	...
	@(crontab -l 2>/dev/null; \
	  ...
	  echo "0 16 * * 1-5 cd /home/niwa_kazuhiro/stockManegement && source venv/bin/activate && /home/niwa_kazuhiro/stockManegement/venv/bin/python main.py daily && /home/niwa_kazuhiro/stockManegement/scripts/send_report.sh daily > /cron_daily_evening.log 2>&1"; \
	  echo "# Weekly tasks (Saturday 10:00 AM)"; \
	  echo "0 10 * * 6 cd /home/niwa_kazuhiro/stockManegement && source venv/bin/activate && /home/niwa_kazuhiro/stockManegement/venv/bin/python main.py weekly && /home/niwa_kazuhiro/stockManegement/scripts/send_report.sh weekly > /cron_weekly.log 2>&1"; \
	  echo "# Monthly tasks (1st day 10:00 AM)"; \
	  echo "0 10 1 * * cd /home/niwa_kazuhiro/stockManegement && source venv/bin/activate && /home/niwa_kazuhiro/stockManegement/venv/bin/python main.py monthly && /home/niwa_kazuhiro/stockManegement/scripts/send_report.sh monthly > /cron_monthly.log 2>&1"; \
